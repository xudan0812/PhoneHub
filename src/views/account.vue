          ...
          <div class="avatar gray-box clear">
            ...
            <div class="box-inner">
              <ul class="account-nav">
                <router-link :to="{name: 'Account'}" tag="li" exact activeClass="current"><a href="javascript:;">My Orders</a></router-link>
                <li class=""><a href="javascript:;">Shipping Information</a></li>
              </ul>
            </div>
          </div>
        </div>
