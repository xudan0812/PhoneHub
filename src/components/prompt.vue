...
<style>
  ...
  .module-dialog .dialog-close{
    ...
    height: 17px;
    padding: 4px 5px;
    background: url(../../src/assets/img/ui.png) no-repeat -16px -16px;
    text-indent: -9999em;
    opacity: .7;
    cursor: pointer;
  ...
  .module-dialog .dialog-btn-wrap{
    ...
    background: url(../../src/assets/img/account-bottom-bar-bg.png) 0 0 repeat-x;
  }
